...
try{
  ...
  for(const suite of ['test.js','tests/everyday.test.js','tests/v1.5.test.js','tests/v1.6.test.js','tests/v1.7.test.js','tests/v1.7.1.test.js','tests/v1.8.test.js','tests/v1.8.1.test.js','tests/v1.8.2.test.js','tests/v1.8.2-process-crash.test.js']){
